/*Write a C++ program to read K Lists of names and merge operation using K-way merge algorithm with K = 4.Display the contents of all lists.*/
...
void coseq::read_file(int i)
{
	...
	switch(i)
	{
		...
		case 1: fp.open("list2.txt",ios::out);
			   	cout<<"Enter the number of name you want to enter in LIST "<<i+1<< ": \n";
			   	cin>>n;
		   		cout<<"Enter "<<n<<" names:\n";
			   	for(j=0;j<n;j++)
		...
		case 2:fp.open("list3.txt",ios::out);
			   cout<<"Enter the number of name you want to enter in LIST "<<i+1<< ": \n";
			   cin>>n;
			   cout<<"Enter "<<n<<" names:\n";
			   for(j=0;j<n;j++)
		...
		case 3:fp.open("list4.txt",ios::out);
			   cout<<"Enter the number of name you want to enter in LIST "<<i+1<< ": \n";
			   cin>>n;
			   cout<<"Enter "<<n<<" names:\n";
			   for(j=0;j<n;j++)
